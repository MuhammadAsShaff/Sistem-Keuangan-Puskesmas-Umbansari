...
class DataPengeluaranControllerAdmin extends Controller
{
    ...
    public function totalPengeluaran()
    {
        ...
        return view('dataPengeluaranAdmin.index', compact('totalPengeluaran'));
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('dataPengeluaranAdmin.index', compact('data', 'totalPengeluaran', 'bulanKeluar', 'tanggalKeluar', 'jumlahNominal'));
    }
    ...
    {
        return view('dataPengeluaranAdmin.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dataPengeluaranAdmin.index')->with(['success' => 'Data Berhasil Disimpan']);
    }

        public function edit($id)
        {
            $data = DB::table('datapengeluaran1')->where('idPengeluaran', $id)->first();
            return view('dataPengeluaranAdmin.edit', compact('data'));
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('dataPengeluaranAdmin.index')->with(['success' => 'Data Berhasil Diupdate!']);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('dataPengeluaranAdmin.index')->with(['success' => 'Data Berhasil Dihapus!']);
    }
}
