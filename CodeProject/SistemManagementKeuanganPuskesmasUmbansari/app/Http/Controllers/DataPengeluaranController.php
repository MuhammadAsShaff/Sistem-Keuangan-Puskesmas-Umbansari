...
class DataPengeluaranController extends Controller
{
    ...
    public function totalPengeluaran()
    {
        ...
        return view('dataPengeluaran.index', compact('totalPengeluaran'));
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('dataPengeluaran.index', compact('data', 'totalPengeluaran', 'bulanKeluar', 'tanggalKeluar', 'jumlahNominal'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dataPengeluaran.index')->with(['success' => 'Data Berhasil Disimpan']);
    }

        public function edit($id)
        {
            $data = DB::table('datapengeluaran1')->where('idPengeluaran', $id)->first();
            return view('dataPengeluaran.edit', compact('data'));
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('dataPengeluaran.index')->with(['success' => 'Data Berhasil Diupdate!']);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('dataPengeluaran.index')->with(['success' => 'Data Berhasil Dihapus!']);
    }
}
