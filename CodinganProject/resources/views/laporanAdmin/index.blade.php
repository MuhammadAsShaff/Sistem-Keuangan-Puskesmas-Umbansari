                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('laporanAdmin.store') }}" method="post" enctype="multipart/form-data" id="tambahForm">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('typeDana') is-invalid @enderror"
                                                    name="typeDana" placeholder="Penggunaan Dana" required>
                                                @error('typeDana')
                                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                                                @enderror
                                            </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="{{ asset('storage/uploads/' . $dataLaporan->file) }}" class="btn btn-sm btn-success" download id="unduh-laporan">Unduh
                    Laporan</a>
                  @else
                  {{ $dataLaporan->file }}
                  @endif
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <form action="{{ route('laporanAdmin.destroy', $dataLaporan->idLaporan) }}" method="post">
                          @csrf
                          @method('DELETE')
