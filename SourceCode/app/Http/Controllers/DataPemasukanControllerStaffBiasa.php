...
class DataPemasukanControllerStaffBiasa extends Controller
{
    ...
    public function totalPemasukan()
    {
        ...
        return view('dataPemasukanStaffBiasa.index', compact('totalPemasukan'));
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('dataPemasukanStaffBiasa.index', compact('data', 'totalPemasukan', 'bulanMasuk', 'jumlahNominal'));
    }
    ...
    {
        return view('dataPemasukanStaffBiasacreate');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dataPemasukanStaffBiasa.index')->with(['success' => 'Data Berhasil Disimpan']);
    }

        public function edit($id)
        {
            $data = DB::table('datapemasukan1')->where('idPemasukan', $id)->first();
            return view('dataPemasukanStaffBiasaedit', compact('data'));
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('dataPemasukanStaffBiasaindex')->with(['success' => 'Data Berhasil Diupdate!']);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('dataPemasukanStaffBiasaindex')->with(['success' => 'Data Berhasil Dihapus!']);
    }
}
