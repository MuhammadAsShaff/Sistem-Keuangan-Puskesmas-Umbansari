...
<style>
  ...
  <link
    ...
    rel="stylesheet">
  <!-- Font Awesome-->
  @includeIf('layouts.staffBiasa.partials.css')
</head>
...
<body>
  ...
  <div class="page-wrapper" id="pageWrapper">
    <!-- Page Header Start-->
    @includeIf('layouts.staffBiasa.partials.header')
    <!-- Page Header Ends -->
    <!-- Page Body Start-->
    <div class="page-body-wrapper horizontal-menu">
      <!-- Page Sidebar Start-->
      @includeIf('layouts.staffBiasa.partials.sidebar')
      <!-- Page Sidebar Ends-->
      <div class="page-body">
  ...
  <!-- latest jquery-->
  @includeIf('layouts.staffBiasa.partials.js')

  <script src="https://cdn.datatables.net/1.13.7/js/jquery.dataTables.js"></script>
  
  <!-- Skrip untuk mengaktifkan Feather Icons -->
  <script>
