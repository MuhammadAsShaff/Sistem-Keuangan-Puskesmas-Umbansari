                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('dataPengeluaran.store') }}" method="post" enctype="multipart/form-data" id="tambahForm">
                                        @csrf
                                ...
                                <div class="modal fade" id="editModal{{ $dataPengeluaran->idPengeluaran }}"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form
                                                    action="{{ route('dataPengeluaran.update', $dataPengeluaran->idPengeluaran) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('PUT')
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form
                                                    action="{{ route('dataPengeluaran.destroy', $dataPengeluaran->idPengeluaran) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
