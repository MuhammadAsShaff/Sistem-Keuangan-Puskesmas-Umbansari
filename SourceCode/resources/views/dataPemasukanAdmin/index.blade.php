                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('dataPemasukanAdmin.store') }}" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date"
                                                ...
                                                name="tanggalMasuk" placeholder="Tanggal Masuk" required>
                                            @error('tanggalMasuk')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control @error('sumberPemasukan') is-invalid @enderror"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                class="form-control @error('jumlahNominal') is-invalid @enderror"
                                                name="jumlahNominal" placeholder="Jumlah Nominal" required>
                                            @error('jumlahNominal')
                                            <div class="alert alert-danger mt-2">{{ $message }}</div>
                                            @enderror
                                        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <button class="btn btn-pill btn-primary btn-air-primary btn-action" type="button"
        ...
        $(document).ready(function () {
            ...
            if (successMessage) {
                ...
                if (successMessage.includes('Disimpan')) {
                    showSuccessAlert('Data berhasil Simpan!');
